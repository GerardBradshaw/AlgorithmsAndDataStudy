...
public class MyJLinkedListTest {

  private MyJLinkedList linkedList = new MyJLinkedList();
  private MyJLinkedList nullList = new MyJLinkedList();

  @Before
  public void setUp() throws Exception {
    linkedList = new MyJLinkedList(6, 7, 0); // [6] -> [7] -> [0] -> null
  }
  ...
  public void testAddLast_negativeValue() {
    ...
    assertThat(linkedList, is(equalTo(new MyJLinkedList(6, 7, 0, -4))));
  }

  @Test
  public void testAddAtIndex_positiveValueIndexInMiddle() {
    linkedList.addAtIndex(33, 1);
    assertThat(linkedList, is(equalTo(new MyJLinkedList(6, 33, 7, 0))));
  }

  @Test
  public void testAddAtIndex_positiveValueIndexLast() {
    linkedList.addAtIndex(99, 3);
    assertThat(linkedList, is(equalTo(new MyJLinkedList(6, 7, 0, 99))));
  }

  @Test
  public void testAddFirst_positiveValue() {
    linkedList.addFirst(5);
    assertThat(linkedList, is(equalTo(new MyJLinkedList(5, 6, 7, 0))));
  }

  @Test
  public void testAddFirst_positiveValueNullList() {
    nullList.addFirst(5);
    assertThat(nullList, is(equalTo(new MyJLinkedList(5))));
  }
  ...
  public void testSetFirst_validList() {
    ...
    assertThat(linkedList, is(equalTo(new MyJLinkedList(9, 7, 0))));
  }
  ...
  public void testSetLast_validList() {
    ...
    assertThat(linkedList, is(equalTo(new MyJLinkedList(6, 7, 9))));
  }
  ...
  public void testSetAtIndex_indexMiddle() {
    ...
    assertThat(linkedList, is(equalTo(new MyJLinkedList(6, 9, 0))));
  }
  ...
  public void testRemoveItem_firstItem() {
    linkedList.remove(6);
    assertThat(linkedList, is(equalTo(new MyJLinkedList(7, 0))));
  }

  @Test
  public void testRemoveItem_middleItem() {
    linkedList.remove(7);
    assertThat(linkedList, is(equalTo(new MyJLinkedList(6, 0))));
  }

  @Test
  public void testRemoveItem_lastItem() {
    linkedList.remove(0);
    assertThat(linkedList, is(equalTo(new MyJLinkedList(6, 7))));
  }
