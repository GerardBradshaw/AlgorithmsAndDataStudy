...
class MyMaxHeap<T : Comparable<T>>() {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is MyMaxHeap<*> || other.size != size) return false
  ...
  override fun toString(): String {
    ...
    for (i in 1..(size - 1)) builder.append(", ").append(array[i].toString())
